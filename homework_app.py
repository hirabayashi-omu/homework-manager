...
元のローカル版 UI・機能を維持しつつ、JSON を Drive に保存
"""
...
# Google Drive 設定
# -----------------------------
FOLDER_ID = "1O7F8ZWvRJCjRVZZ5iyrcXmFQGx2VEYjG" # ユーザー指定
...
def get_drive_service():
    ...
    # 環境変数 GOOGLE_CREDENTIALS にサービスアカウント JSON を文字列として入れておく
...
# Streamlit 設定
# -----------------------------
st.set_page_config(page_title="Drive永続化版：時間割＆宿題管理アプリ", layout="wide")
...
# =====================
with tabs[0]:
    st.header("時間割入力（Google Drive に保存）")
    days = ["月","火","水","木","金"]
